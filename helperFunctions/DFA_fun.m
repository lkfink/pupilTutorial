...
% DFA implementation for determining the scaling coefficient characterizing 
% the self affinity of the input data. For the interpretation of the outputs 
% and algorithm overview see (e.g.) Peng et al., 1996.

% Martin Magris (2022). Detrended fluctuation analysis (DFA) 
...
% LF added 2021.09.17
if isinf(any(log(F)))
    disp('NaNs in fluctuation estimate. Cannot calculate A. Check window spacing.')
end
